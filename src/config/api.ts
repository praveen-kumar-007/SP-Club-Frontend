...
export const API_ENDPOINTS = {
  ...
  ADMIN_NOC_CLEARANCES: (id: string) => `${API_BASE_URL}/api/admin/registrations/${id}/noc/clearances`,
  ADMIN_NOC_REJECT: (id: string) => `${API_BASE_URL}/api/admin/registrations/${id}/noc/reject`,
