...
const PlayerChangePassword = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-cyan-50 p-4 flex items-center justify-center">
      <Card className="w-full max-w-lg border-slate-200 shadow-md">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex gap-2">
            ...
            <Button onClick={handleSubmit} disabled={isSubmitting} className="flex-1 bg-cyan-700 hover:bg-cyan-800">
