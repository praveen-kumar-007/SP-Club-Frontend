...
const PlayerForgotPassword = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-orange-50 via-white to-blue-50 p-4 flex items-center justify-center">
            <Card className="w-full max-w-lg border-blue-200 shadow-lg">
                ...
                <CardContent className="space-y-4">
                    ...
                    {!otpSent ? (
                        <Button className="w-full bg-blue-800 hover:bg-blue-900" onClick={requestOtp} disabled={sendingOtp}>
                        ...
                        <>
                            ...
                            <Button className="w-full bg-orange-600 hover:bg-orange-700" onClick={resetPassword} disabled={resetting}>
