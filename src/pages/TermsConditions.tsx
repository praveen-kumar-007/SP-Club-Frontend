  ...
  return (
    <div className="bg-gradient-to-b from-slate-900 via-[#0f172a] to-slate-900 text-white min-h-screen">
      <Seo
        ...
        description="SP Sports Academy Terms and Conditions - Membership rules, regulations, and academy policies."
        url="https://spkabaddi.me/terms-conditions"
        keywords="SP Sports Academy terms, sports academy rules, sports membership"
      />
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-slate-400 max-w-2xl mx-auto">
              Please read these terms and conditions carefully before joining SP Sports Academy
            </p>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-slate-300 leading-relaxed">
                  By registering with SP Sports Academy, you agree to comply with all terms, conditions, rules, and regulations set forth by the club and the Amateur Kabaddi Federation of India (AKFI). Violation of these terms may result in disciplinary action, including suspension or termination of membership.
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="pl-6 border-l-2 border-red-500/50 bg-red-500/5 p-4 rounded-lg">
                ...
                <div className="space-y-3">
                  <p className="font-semibold text-white flex items-start gap-2">
                    ...
                    Members must provide a minimum of 14 (fourteen) days written notice before leaving or terminating their membership with SP Sports Academy.
                  </p>
            ...
            <div className="space-y-6 text-slate-300">
              ...
              <div className="pl-6 border-l-2 border-blue-500/50">
                ...
                <ul className="space-y-2 list-disc list-inside">
                  ...
                  <li>Players can view detailed <Link to="/kabaddi-rules" className="text-blue-400 hover:text-blue-300 underline">SP Sports Academy Kabaddi Rules</Link> (based on AKFI)</li>
                </ul>
              </div>
              ...
              <div className="pl-6 border-l-2 border-blue-500/50 bg-blue-500/5 p-4 rounded-lg">
                ...
                <div className="space-y-3">
                  <p className="font-semibold text-white flex items-start gap-2">
                    ...
                    Any SP Sports Academy member wishing to play for another club or team must obtain a No Objection Certificate (NOC) from SP Sports Academy management.
                  </p>
                  <ul className="space-y-2 list-disc list-inside ml-7">
                    ...
                    <li>Playing for another club/team without obtaining a proper NOC is considered a serious breach and will result in:
                      <ul className="ml-6 mt-2 space-y-1 list-circle list-inside">
                        <li>Immediate suspension from SP Sports Academy</li>
                        <li>Reporting to AKFI and state kabaddi associations</li>
                        <li>Disqualification from future SP Sports Academy tournaments and events</li>
                        <li>Legal action if necessary</li>
                      </ul>
                    </li>
                    <li>NOC may be granted subject to conditions including but not limited to:
                      <ul className="ml-6 mt-2 space-y-1 list-circle list-inside">
                        <li>No pending commitments with SP Sports Academy</li>
                        <li>Clearance of all dues and fees</li>
                        <li>No conflict with SP Sports Academy's tournament schedule</li>
              ...
              <div className="pl-6 border-l-2 border-blue-500/50">
                ...
                <ul className="space-y-2 list-disc list-inside">
                  ...
                  <li>Disciplinary actions imposed by AKFI will be binding on all SP Sports Academy members.</li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div className="mb-12 bg-slate-800/50 backdrop-blur border border-slate-700/50 rounded-xl p-8">
            ...
            <div className="space-y-6 text-slate-300">
              <div className="pl-6 border-l-2 border-amber-500/50">
                ...
                <ul className="space-y-2 list-disc list-inside">
                  <li>SP Sports Academy reserves the right to amend these terms and conditions at any time.</li>
              ...
              <div className="pl-6 border-l-2 border-amber-500/50">
                ...
                <ul className="space-y-2 mt-3">
                  <li><strong>SP Sports Academy</strong></li>
