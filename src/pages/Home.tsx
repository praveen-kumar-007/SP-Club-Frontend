...
const Home = () => {
  return (
    <>
      <Helmet>
        <title>SP Club - Premier Sports Community in Dhanbad, India</title>
        <meta name="description"
          content="Join SP Club, Dhanbad's leading sports community. Expert coaching, world-class facilities, and championship training in kabaddi, cricket, football, basketball & more. Register today!" />
        <meta name="keywords"
          content="sports club Dhanbad, cricket coaching, football training, basketball, swimming, sports community India, athletics training, sports membership" />
        <meta name="author" content="SP Club" />
      </Helmet>
