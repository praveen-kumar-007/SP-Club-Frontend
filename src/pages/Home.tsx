...
const Home = () => {
  ...
  const galleryImages = [
    ...
    },
    {
      ...
      alt: "The First Team of SP Sports Academy.",
    },
    {
      id: 4,
  ...
  return (
    <div className="min-h-screen bg-gray-50 font-sans">
      <Seo
        title="Home"
        description="SP Sports Academy — training champions since 2010. Join our programs, events, and community."
        url="https://spkabaddi.me/"
        keywords="SP Sports Academy, sports academy Dhanbad, athletics training, sp sports academy"
      />
      {/* Hero Section */}
      <section className="relative h-screen flex items-center justify-center text-white overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
          <h1 className="text-5xl md:text-7xl font-extrabold mb-6 tracking-tight animate-fade-in-up shadow-text">
            Welcome to <span className="text-amber-400">SP Sports Academy</span>
          </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="max-w-xl">
              ...
              <p className="text-lg text-gray-600 mb-8">
                Discover the passion, dedication, and triumphs that have defined SP Sports Academy as a powerhouse in Indian sports.
              </p>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-slate-400 max-w-2xl mx-auto">
              Celebrating the moments and the members who make SP Sports Academy exceptional.
            </p>
          </div>
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-4 text-slate-800">Why Choose SP Sports Academy?</h2>
      ...
      <section className="py-20 bg-slate-800 text-white">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-xl mb-10 max-w-3xl mx-auto text-slate-300">
            Take the first step towards achieving your sporting dreams with SP Sports Academy.
          </p>
