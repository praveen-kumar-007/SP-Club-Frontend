...
const About = () => {
  ...
  const teamMembers = [
    {
      ...
      role: "President",
      bio: "With over 15 years of experience, Pappu founded SP Sports Academy to create a new generation of champions.",
    ...
    },
    {
      name: "Sunny Ray",
      role: "Secretary",
      bio: "Sunny ensures the smooth operation of SP Sports Academy, managing finances and logistics with precision.",
  ...
  const historyMilestones = [
    {
      ...
      description: "SP Sports Academy was founded with a vision to create a premier sports facility in Dhanbad, starting with just 50 members and 3 sports."
    },
    {
      year: "2015",
  ...
  return (
    <div className="bg-gradient-to-b from-slate-900 via-[#0f172a] to-slate-900 text-white">
      <Seo
        title="About"
        description="Learn about SP Sports Academy — our mission, history, and core team dedicated to building champions."
        url="https://spkabaddi.me/about"
        keywords="about SP Sports Academy, sports history Dhanbad, sp sports academy"
      />
      ...
      <section className="relative py-40 overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
          ...
          <h1 className="text-6xl md:text-7xl lg:text-8xl font-extrabold mb-6 tracking-tight">
            About <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-orange-500">SP Sports Academy</span>
          </h1>
      ...
      <section className="py-28 bg-slate-900 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="text-center mb-20">
            ...
            <p className="text-lg text-slate-400 max-w-2xl mx-auto">Follow the key moments that shaped SP Sports Academy into the powerhouse it is today</p>
          </div>
      ...
      <section className="py-28 bg-gradient-to-b from-slate-800 to-slate-900">
        <div className="container mx-auto px-6">
          <div className="text-center mb-20">
            ...
            <p className="text-lg text-slate-400 max-w-3xl mx-auto">The dedicated leaders who drive SP Sports Academy's mission and inspire excellence every single day</p>
          </div>
