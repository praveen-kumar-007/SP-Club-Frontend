    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-emerald-50 p-3 sm:p-4 md:p-8">
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <Card>
          ...
          <CardContent>
            <div className="mb-6 flex flex-col gap-4 md:flex-row md:items-center md:justify-between rounded-lg border border-emerald-100 bg-emerald-50/40 p-4">
              <div className="flex w-full flex-col items-center gap-4 sm:flex-row sm:items-start">
                {player?.photo ? (
                  <div className="h-40 w-40 shrink-0 overflow-hidden rounded-xl border-2 border-emerald-200 bg-white shadow-sm sm:h-44 sm:w-44 md:h-48 md:w-48">
                    <img
                      src={player.photo}
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <Card>
            ...
            <CardContent>
              <Button className="w-full sm:w-auto bg-cyan-700 hover:bg-cyan-800" onClick={() => navigate("/player/change-password")}>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <Card>
            ...
            <CardContent>
              <Button className="w-full sm:w-auto bg-emerald-600 hover:bg-emerald-700" onClick={() => navigate("/player/attendance")}>
          ...
          <Card>
            ...
            <CardContent>
              <Button className="w-full sm:w-auto bg-emerald-600 hover:bg-emerald-700" onClick={() => navigate("/player/messages")}>
                Open Message Page
              </Button>
            </CardContent>
          </Card>
